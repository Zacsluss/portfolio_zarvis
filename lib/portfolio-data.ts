...
export const portfolioData: PortfolioData = {
  ...
  experience: [
    ...
    },
    {
      ...
      startDate: "2019-09",
      endDate: "2021-10",
      description: "Led key technology-enabled lending initiatives within CIT's $46M+ national syndicate business portfolio, integrating automation, compliance, and data-driven decision frameworks.",
      achievements: [
