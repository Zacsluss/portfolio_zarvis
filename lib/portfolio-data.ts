...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    tagline: "Leading enterprise CRM and platform transformation for thousands of global users across 20+ countries, governing $1M–$10M+ technology portfolios with measurable ROI and strong compliance outcomes",
    bio: "I design and govern the digital ecosystems that keep global enterprises running - spanning Salesforce, ERP, and data clouds across 20+ countries with portfolios in the $1M–$10M+ range. I turn complexity into clarity, automation into scale, and platforms into measurable growth - delivering 40%+ productivity gains through strategic platform leadership.\n\nBy day, I architect multi-cloud systems and contribute to multi-million-dollar vendor strategies; by night, I build unique digital experiences and pilot drones through physics-defying spaces. Whether it's enterprise architecture or visual experiments, my work always comes down to the same thing: precision, performance, and a curiosity that never switches off.",
  ...
  experience: [
    ...
    },
    {
      ...
      startDate: "2018-06",
      endDate: "2019-07",
      description: "Led technology-driven risk initiatives and process modernization for a $10B+ annual transaction portfolio, helping architect automated risk analytics and compliance workflows within enterprise credit systems.",
      achievements: [
    ...
    },
    {
      ...
      startDate: "2017-03",
      description: "Founded and scaled multi-channel digital ventures spanning e-commerce, creative media, and analytics-driven services - using them as a lab for automation, cloud systems, and emerging tech that later informed enterprise CRM and platform work.",
      achievements: [
  ...
  skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Google Cloud Platform (GCP)", level: "Intermediate", years: 2 },
        { name: "Infrastructure as Code (CloudFormation, Terraform)", level: "Intermediate", years: 2 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Data Governance & Compliance (SOX, GDPR, CCPA)", level: "Expert", years: 6 },
        { name: "Okta SSO", level: "Intermediate", years: 2 },
        { name: "OneTrust", level: "Intermediate", years: 2 },
        { name: "Palo Alto Prisma Cloud", level: "Intermediate", years: 2 },
        { name: "SOX Compliance", level: "Expert", years: 6 },
    ...
    },
    {
      ...
      skills: [
        { name: "AI/ML Enablement & Enterprise Automation", level: "Advanced", years: 4 },
        { name: "Blue Prism", level: "Intermediate", years: 2 },
        { name: "Make (Integromat)", level: "Intermediate", years: 2 },
        { name: "Pipedream", level: "Intermediate", years: 2 },
        { name: "Power Automate", level: "Advanced", years: 4 },
        { name: "UiPath", level: "Intermediate", years: 2 },
        { name: "Workato", level: "Intermediate", years: 2 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Microsoft Power Platform", level: "Expert", years: 6 },
        { name: "Oracle Cloud Applications", level: "Advanced", years: 4 },
        ...
        { name: "Salesforce Flow", level: "Expert", years: 6 },
        { name: "Salesforce Marketing Cloud", level: "Advanced", years: 4 },
        ...
        { name: "ServiceNow (flows & governance)", level: "Expert", years: 5 },
        { name: "Workday HCM", level: "Advanced", years: 4 },
        { name: "Zoho CRM", level: "Intermediate", years: 2 },
      ],
    },
    {
      category: "Integration & Data Orchestration",
      skills: [
        { name: "API Management (Apigee, Kong)", level: "Intermediate", years: 2 },
        { name: "API-led Integration", level: "Expert", years: 6 },
        { name: "Google BigQuery", level: "Advanced", years: 3 },
        { name: "MuleSoft", level: "Expert", years: 6 },
        { name: "Oracle Database", level: "Advanced", years: 4 },
